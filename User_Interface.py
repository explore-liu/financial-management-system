...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, UserWindow):
        ...
        self.label.setText(_translate("UserWindow", "用户界面"))
        ...
        self.label_15.setText(_translate("UserWindow", "工号"))
        self.label_17.setText(_translate("UserWindow", "入职年份"))
        self.label_19.setText(_translate("UserWindow", "性别"))
        self.label_21.setText(_translate("UserWindow", "电话"))
        self.label_23.setText(_translate("UserWindow", "邮箱"))
        self.label_16.setText(_translate("UserWindow", "TextLabel"))
        self.label_18.setText(_translate("UserWindow", "TextLabel"))
        self.label_20.setText(_translate("UserWindow", "TextLabel"))
        self.label_22.setText(_translate("UserWindow", "TextLabel"))
        self.label_24.setText(_translate("UserWindow", "TextLabel"))
        self.label_6.setText(_translate("UserWindow", "个人薪资情况"))
        self.label_4.setText(_translate("UserWindow", "薪资等级"))
        self.label_10.setText(_translate("UserWindow", "当月工资"))
        self.label_25.setText(_translate("UserWindow", "TextLabel"))
        self.label_26.setText(_translate("UserWindow", "TextLabel"))
        self.label_11.setText(_translate("UserWindow", "本季度工资"))
        self.label_27.setText(_translate("UserWindow", "TextLabel"))
        self.label_50.setText(_translate("UserWindow", "TextLabel"))
        self.label_51.setText(_translate("UserWindow", "本年工资"))
        self.label_8.setText(_translate("UserWindow", "修改密码"))
        self.label_2.setText(_translate("UserWindow", "修改成功！"))
        self.label_12.setText(_translate("UserWindow", "两次密码不相符！"))
